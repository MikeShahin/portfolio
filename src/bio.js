    ...
    return(
        <div className="bio">
            <p>
                ...
                The following are my greatest projects I have created during my learn-to-code journey, I hope you enjoy. You can also check out my Github (linked above) to see all my projects and coding exercises.
            </p>
        </div>
    )
}
